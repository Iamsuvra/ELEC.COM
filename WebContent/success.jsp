...
<body>
	...
	<c:choose>
		...
		<c:when test="${session != null}">
				...
				<div class="container" style="margin-top: 60px;margin-bottom: 60px;">
					<h4>Thank you <font color="#6bb1f8"><c:out value="${name }"></c:out></font> for Shopping with us. We received your order and it will be delivered to <font color="#6bb1f8"><c:out value="${address }"></c:out></font> with in 2-3 working days.</h4>
	...
	<footer style="position: fixed;bottom: 0;left: 0;width: 100%;">
		<div class="footer"> &copy; 2019 Copyright:
	      <a href="Controller?page=index"> Elec.com</a>
	    </div>
	</footer>
</body>
</html>