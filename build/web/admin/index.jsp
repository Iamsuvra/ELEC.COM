...
<body>
	<header>
	 ...
	 <sql:setDataSource user="root" password="" driver="com.mysql.jdbc.Driver" url="jdbc:mysql://localhost:3306/records" var="ds"/>
		 ...
		 <c:forEach items="${result.rows }" var="row">
		  <table style="table-layout: fixed;width: 100%;">
				...
				<tr>
					...
					<td style="width: 100px;"><c:out value="${row.desciption}"/></td>
