...
<header>
	...
	<div class="signup-header">
	 	<h2>Login to <mark>Electronics</mark></h2>
	</div>
	 ...
	 <input type="hidden" name="page" value="login-form">
	 	...
	 	<p>
	 		New to Electronics? <a href="Controller?page=sign-up" style="color:#F24638;">Create Account</a>
	 	</p>
	 </form>
	<br><br><br>
	<footer style="position: fixed;bottom: 0;left: 0;width: 100%;">
		<div class="footer"> &copy; 2019 Copyright:
	      <a href="Controller?page=index"> Electronics.com</a>
	    </div>
	</footer>
